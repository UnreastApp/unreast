    ...
    return(
        <DropdownMenu>
            ...
            <DropdownMenuTrigger className="focus:outline-none" asChild>
                <button className="w-full text-sm text-foreground bg-background hover:bg-card/50 px-3 flex items-center h-12">
                    {office.name}
            ...
            <DropdownMenuContent className="w-56 text-xs space-y-[2px]">
                {(isAdmin || isModerator) && (
                    <DropdownMenuItem
                        ...
                        className="cursor-pointer text-primary font-medium hover:bg-secondary/30 px-3 py-2">
                        Invite People
                ...
                {(isAdmin || isModerator) && (
                    <DropdownMenuItem className="cursor-pointer hover:bg-secondary/30 px-3 py-2">
                        Office Settings
                ...
                <Separator/>
                {( isModerator || isGuest) && (
                    <DropdownMenuItem className="cursor-pointer hover:bg-secondary/30 font-medium text-destructive/80 px-3 py-2">
                        Leave Office
