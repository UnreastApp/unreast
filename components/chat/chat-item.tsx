...
import { Edit, FileIcon, ShieldAlert, ShieldCheck, Trash, User } from "lucide-react";
...
const roleIconMap = {
  "GUEST": <User className="h-4 w-4 ml-2" />,
...
export const ChatItem = ({
  ...
  const onMemberClick = () => {
    ...
    router.push(`/offices/${params?.officeId}/conversations/${member.id}`);
  }
    ...
    <div className="relative group flex items-center p-4 transition w-full">
      <div className="group flex gap-x-2 items-start w-full">
        ...
        <div className="flex flex-col w-full">
          ...
          {isPDF && (
            <div className="relative flex bg-primary-foreground items-center p-2 mt-2  rounded-md">
          ...
          {!fileUrl && isEditing && (
            <Form {...form}>
                    ...
                    <FormItem className="flex-1">
                      <FormControl>
                        <div className="relative w-full">
                          <Input
                            disabled={isLoading}
                            className="p-2 border-none border-0 focus-visible:ring-0 focus-visible:ring-offset-0"
              ...
              <span className="text-[10px] mt-1 t">
